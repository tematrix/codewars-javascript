...
минимум из 4 положительных целых чисел. В массиве не будет чисел с плавающей запятой или отрицательных чисел.

Например, при передаче массива [19, 5, 42, 2, 77] функция должна вернуть 7.
