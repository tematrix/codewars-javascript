...
Kata.getMiddle("тест") должен возвращать "es"

Kata.getMiddle("тестирование") должен возвращать "t"

Kata.getMiddle("middle") должен возвращать "dd"

Kata.getMiddle("A") должен возвращать "A"
#Ввод

Слово (строка) длиной 0 < str < 1000 (в javascript вы можете получить 
немного больше 1000 в некоторых тестовых примерах из-за ошибки в тестовых примерах). 
Вам не нужно проводить тестирование для этого. Это сделано только для того, 
